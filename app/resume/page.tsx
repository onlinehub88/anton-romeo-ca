      ...
      <div className="container mx-auto px-4 py-16 sm:px-6 lg:px-8">
        <div className="mb-8 flex flex-wrap items-center justify-between gap-4">
          <div>
            ...
            <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">
              <span className="bg-gradient-to-r from-white to-zinc-500 bg-clip-text text-transparent">Resume</span>
            </h1>
          </div>
          <Button asChild>
            <a
        ...
        <div className="rounded-xl border border-white/10 bg-white/5 p-8 backdrop-blur-sm">
          <div className="mb-8 grid gap-4 md:grid-cols-[2fr_1fr]">
            <div>
              <h2 className="text-2xl font-bold">Anton Romeo</h2>
          ...
          <section className="mb-8">
            <h3 className="mb-4 text-xl font-bold">Core Skills</h3>
            <div className="space-y-4">
              ...
              <div>
                <h4 className="mb-2 font-medium">AI & GenAI</h4>
                <p className="text-zinc-300">
              ...
              <div>
                <h4 className="mb-2 font-medium">Backend & Frontend</h4>
                <p className="text-zinc-300">
          ...
          <section className="mb-8">
            <h3 className="mb-4 text-xl font-bold">Professional Experience</h3>
            <div className="space-y-6">
              <div>
                <div className="mb-2 flex flex-wrap items-start justify-between gap-2">
                  <div>
                    <h4 className="font-medium">AI Software Engineer</h4>
                    <p className="text-zinc-400">BeckTek</p>
                  </div>
              ...
              <div>
                <div className="mb-2 flex flex-wrap items-start justify-between gap-2">
                  <div>
                    ...
                    <p className="text-zinc-400">Sedin Technologies</p>
                  </div>
                  <Badge variant="outline" className="border-white/20 bg-white/5">
                    09/2020 - 02/2022
                  </Badge>
              ...
              <div>
                <div className="mb-2 flex flex-wrap items-start justify-between gap-2">
                  <div>
                    ...
                    <p className="text-zinc-400">Aatio</p>
                  </div>
                  <Badge variant="outline" className="border-white/20 bg-white/5">
                    04/2018 - 08/2020
                  </Badge>
            ...
            <div>
              <div className="mb-2 flex flex-wrap items-start justify-between gap-2">
                <div>
                  ...
                  <p className="text-zinc-400">University of New Brunswick</p>
                </div>
                <Badge variant="outline" className="border-white/20 bg-white/5">
                  2012 - 2016
                </Badge>
          ...
          <section>
            <h3 className="mb-4 text-xl font-bold">Key Skills</h3>
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="rounded-lg border border-white/10 bg-white/5 p-4">
                <h4 className="font-medium">AI & Machine Learning</h4>
                <p className="text-sm text-zinc-400">LLM integration, RAG pipelines, Vector databases, Prompt engineering</p>
              </div>
              <div className="rounded-lg border border-white/10 bg-white/5 p-4">
                <h4 className="font-medium">Backend Development</h4>
                <p className="text-sm text-zinc-400">FastAPI, Node.js, Python, REST/GraphQL APIs, Microservices</p>
              </div>
              <div className="rounded-lg border border-white/10 bg-white/5 p-4">
                <h4 className="font-medium">Frontend Development</h4>
                <p className="text-sm text-zinc-400">React, Next.js, TypeScript, Redux, Responsive Design</p>
              </div>
              <div className="rounded-lg border border-white/10 bg-white/5 p-4">
                <h4 className="font-medium">Cloud & DevOps</h4>
                <p className="text-sm text-zinc-400">AWS, Docker, Kubernetes, CI/CD, Infrastructure as Code</p>
              </div>
            </div>
          </section>
        </div>
